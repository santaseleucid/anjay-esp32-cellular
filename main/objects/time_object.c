/**
 * Generated by anjay_codegen.py on 2021-11-13 13:28:26
 *
 * LwM2M Object: Time
 * ID: 3333, URN: urn:oma:lwm2m:ext:3333:1.1, Optional, Multiple
 *
                         ...
                         anjay_output_ctx_t *ctx)
{
    ...
    case RID_FRACTIONAL_TIME:
        assert(riid == ANJAY_ID_INVALID);
        return anjay_ret_double(ctx, 0); // TODO
                          ...
                          anjay_input_ctx_t *ctx)
{
    ...
    case RID_FRACTIONAL_TIME:
    {
        assert(riid == ANJAY_ID_INVALID);
        double value;                         // TODO
        return anjay_get_double(ctx, &value); // TODO
    }
